...
_SCENE_FIELDS_RULES = (
    ...
    'EVIDENCE STATE MAP — include "visual_beats" in narration order. A state is a visible world '
    'change, not a camera angle. HOW MANY depends on how long the scene RUNS, because each state '
